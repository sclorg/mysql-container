...
The RHEL image is available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhscl/mysql-80-rhel7)
as registry.access.redhat.com/rhscl/mysql-80-rhel7.
The CentOS image is then available on [Docker Hub](https://hub.docker.com/r/centos/mysql-80-centos7/)
as centos/mysql-80-centos7.
...
```
$ s2i build ~/image-configuration/ rhscl/mysql-80-rhel7 my-mysql-rhel7
```
